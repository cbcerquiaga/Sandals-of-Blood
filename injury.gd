...
func roll_collision_injury(): #from tackling — any body part can be hurt in a collision
	var possible_injuries = {
		...
		"pulled_groin_major": 0.3,
		"bruised_crotch_minor": 3.0,
		"bruised_crotch_major": 1.0,
		"destroyed_crotch": 0.01,
		# Ribs / torso
		...
		"chest_trauma": 0.05,
		"pinched_nerve": 1.0,
		"spine_damage_minor": 0.15,
		"spine_damage_major": 0.01,
		# Shoulder / collarbone
		"bruised_shoulder_minor": 8.0,
		"bruised_shoulder_major": 4.0,
		"disclocated_shoulder": 2.0,
		"torn_rotator_cuff": 2.0,
		"broken_collarbone": 0.5,
		"broken_upper_arm": 0.5,
		# Arm / elbow
		"bruised_arm_minor": 10.0,
		"bruised_arm_major": 5.0,
		"bruised_elbow_minor": 10.0,
		"bruised_elbow_major": 5.0,
		"dislocated_elbow": 3.0,
		"broken_elbow": 1.0,
		"torn_elbow_ligament": 0.2,
		# Wrist / hand / finger
		"bruised_wrist_minor_dominant": 3.0,
		"bruised_wrist_major_dominant": 2.0,
		"broken_wrist_dominant": 1.0,
		"bruised_wrist_minor_weak": 3.0,
		"bruised_wrist_major_weak": 2.0,
		"broken_wrist_weak": 1.0,
		"bruised_finger_minor_dominant": 3.5,
		"bruised_finger_major_dominant": 2.5,
		"broken_finger_dominant": 1.5,
		"sprain_thumb_dominant": 1.0,
		"bruised_finger_minor_weak": 3.5,
		"bruised_finger_major_weak": 2.5,
		"broken_finger_weak": 1.5,
		"peck_pull_minor": 0.8,
		"peck_pull_major": 0.4,
		"bicep_pull_minor": 0.6,
		"bicep_pull_major": 0.3,
		"tricep_pull_minor": 0.6,
		"tricep_pull_major": 0.3,
		# Head / face
		"nose_bleed": 2.0,
		"nose_broken": 0.5,
		"eyes_bruised": 0.4,
...
func roll_fight_injury(): #from being punched and jostled around
	var possible_injuries = {
		...
		"brain_back_trauma": 0.02,
		"bruised_rib_minor": 4.0,
		"bruised_rib_major": 2.0,
		"broken_rib": 0.08,
		"chest_bruise_minor": 0.5,
		"chest_bruise_major": 0.25,
		"chest_trauma": 0.01,
		"bruised_thigh_minor": 0.3,
		"bruised_thigh_major": 0.15,
	}
	return get_weighted_choice(possible_injuries)

func roll_fight_attack_injury(): #from punching and grabbing opponent
	var possible_injuries = {
		"bruised_finger_minor_dominant": 5.0,
		"bruised_finger_major_dominant": 3.0,
		"broken_finger_dominant": 1.0,
		"bruised_wrist_minor_dominant": 0.6,
		"bruised_wrist_major_dominant": 0.4,
		"broken_wrist_dominant": 0.2,
		"bruised_elbow_minor": 0.5,
		"bruised_finger_minor_weak": 4.7,
		"bruised_finger_major_weak": 2.7,
		"broken_finger_weak": 0.7,
		"bruised_wrist_minor_weak": 0.53,
		"bruised_wrist_major_weak": 0.33,
		"broken_wrist_weak": 0.13,
		"bruised_elbow_weak": 0.43,
		"bruised_elbow_major": 0.14,
		"bicep_pull_minor": 0.2,
		"peck_pull_minor": 0.0,
	}
	return get_weighted_choice(possible_injuries)
...
func roll_noncontact_injury(): #from running, jumping, turning
	var possible_injuries = {
		"ankle_bruise_minor": 2.0,
		"ankle_bruise_major": 2.0,
		...
		"calf_pull_minor": 1.0,
		"calf_pull_major": 0.2,
		"sprained_ACL_minor": 0.35,
		"sprained_ACL_major": 0.25,
		"torn_ACL": 0.15,
		"sprained_LCL_minor": 0.15,
		"sprained_LCL_major": 0.08,
		"torn_meniscus": 0.12,
		"pulled_groin_minor": 1.0,
		"pulled_groin_major": 0.5,
		"torn_labrum": 0.06,
	}
	return get_weighted_choice(possible_injuries)
...
func roll_diving_injury(): #from jumping onto the ground
	var possible_injuries = {
		"bruised_shoulder_minor": 20.0,
		"bruised_shoulder_major": 2.0,
		"disclocated_shoulder": 4.5,
		"broken_collarbone": 0.5,
		"bruised_elbow_minor": 25.0,
		"bruised_elbow_major": 5.0,
		"dislocated_elbow": 1.0,
		"bruised_finger_minor_dominant": 6.0,
		"bruised_finger_minor_weak": 4.0,
		"bruised_finger_major_dominant": 2.0,
		"bruised_finger_major_weak": 1.5,
		"broken_finger_dominant": 1.0,
		"broken_wrist_dominant": 1.0,
		"bruised_wrist_minor_dominant": 5.5,
		"bruised_wrist_major_dominant": 3.2,
		"bruised_wrist_minor_weak": 1.5,
		"bruised_wrist_major_weak": 1.0,
		"broken_wrist_weak": 1.0,
		"bruised_knee_minor": 6.0,
		"bruised_knee_major": 2.0,
...
func roll_ball_kicking_injury(): #from kicking the ball
	var possible_injuries = {
		"toenail_off": 0.2,
		"toe_bruise_minor": 15.0,
		"toe_bruise_major": 7.5,
		"broken_toe": 2.0,
		"foot_bruise_minor": 9.0,
		"foot_bruise_major": 6.0,
		"broken_foot": 0.8,
		"ankle_bruise_minor": 1.0,
		"ankle_bruise_major": 0.6,
		"sprain_ankle_minor": 0.2,
		"sprain_ankle_major": 0.1,
		"bruised_shin_minor": 1.0,
		"bruised_shin_major": 0.1,
		"quad_pull_minor": 1.0,
		"quad_pull_major": 0.45,
		"ham_pull_minor": 0.8,
		"ham_pull_major": 0.37,
		"calf_pull_minor": 0.9,
		"calf_pull_major": 0.21,
	}
	return get_weighted_choice(possible_injuries)

func roll_ball_punching_injury(): #from hitting the ball with hand
	var possible_injuries = {
		"bruised_finger_minor_dominant": 8.0,
		"bruised_finger_major_dominant": 4.0,
		"broken_finger_dominant": 2.0,
		"sprain_thumb_dominant": 1.0,
		"bruised_wrist_minor_dominant": 0.9,
		"bruised_wrist_major_dominant": 0.3,
		"bruised_finger_minor_weak": 6.0,
		"bruised_finger_major_weak": 3.0,
		"broken_finger_weak": 1.6,
		"sprain_thumb_weak": 0.8,
		"bruised_wrist_minor_weak": 0.6,
		"bruised_wrist_major_weak": 0.2,
		"broken_wrist_dominant": 0.05,
		"broken_wrist_weak": 0.04,
		"bruised_elbow_minor": 0.01,
		"peck_pull_minor": 0.05,
		"peck_pull_major": 0.01,
		"tricep_pull_minor": 0.05,
		"tricep_pull_major": 0.01
	}
	return get_weighted_choice(possible_injuries)

func roll_ball_throwing_injury(): #from overuse or overexertion throwing
	var possible_injuries = {
		"torn_rotator_cuff": 5.0,
		"torn_elbow_ligament": 2.0,
		"bicep_pull_minor": 5.0,
		"bicep_pull_major": 2.0,
		"tricep_pull_minor": 1.3,
		"peck_pull_minor": 1.0,
		"peck_pull_major": 1.0,
		"dislocated_shoulder": 1.0,
		"dislocated_elbow": 1.0
	}
	return get_weighted_choice(possible_injuries)
...
func roll_ball_block_injury(): #from being hit with the ball in the crotch, torso, arm, leg, or head
	var possible_injuries = {
		"bruised_crotch_minor": 5.0,
		"bruised_crotch_major": 2.0,
		"destroyed_crotch": 0.01,
		"chest_bruise_minor": 25.0,
		"chest_bruise_major": 10.0,
		"broken_rib": 0.2,
		"bruised_arm_minor": 16.0,
		"bruised_arm_major": 8.0,
		"bruised_thigh_minor": 20.0,
		"bruised_thigh_major": 4.0,
		"broken_thigh": 0.01,
		"bruised_shin_minor": 25.0,
		"bruised_shin_major": 10.0,
		"broken_shin": 0.02,
		"eyes_bloodied": 1.0,
		"eyes_bruised": 1.0,
		"nose_bleed": 2.0,
...
func roll_trip_injury(): #from being tripped
	var possible_injuries = {
		...
		"broken_ankle": 1.0,
		"bruised_knee_minor": 7.0,
		"bruised_knee_major": 3.5,
		"broken_kneecap": 1.75,
		"bruised_shin_minor": 10.0,
		"bruised_shin_major": 5.0,
		"broken_shin": 1.0,
		"leg_cut_minor": 5.0,
		"leg_cut_major": 2.0,
		"bruised_wrist_minor_dominant": 3.0,
		"bruised_wrist_major_dominant": 1.0,
		"broken_wrist_dominant": 0.4,
		"bruised_wrist_minor_weak": 3.0,
		"bruised_wrist_major_weak": 1.0,
		"broken_wrist_weak": 0.4,
		"sprained_ACL_minor": 1.0,
		"sprained_ACL_major": 0.5,
		"torn_ACL": 0.25,
		"sprained_LCL_minor": 0.8,
		"sprained_LCL_major": 0.4,
		"torn_LCL": 0.2,
		"torn_meniscus": 0.1,
		"broken_jaw": 0.01
	}
...
func roll_trip_attack_injury(): #for the player who attempts to trip an opponent
	var possible_injuries = {
		...
		"sprain_ankle_major": 1.0,
		"broken_ankle": 0.02,
		"bruised_shin_minor" : 8.0,
		"bruised_shin_major": 2.0,
		"broken_shin": 0.05,
		"bruised_knee_minor": 4.0,
		"bruised_knee_major": 2.0,
		"broken_kneecap": 1.0,
		"sprained_ACL_minor": 0.5,
		"sprained_ACL_major": 0.25,
		"torn_ACL": 0.13,
		"sprained_LCL_minor": 0.4,
		"sprained_LCL_major": 0.2,
		"torn_LCL": 0.1,
		"torn_meniscus": 0.05,
	}
	return get_weighted_choice(possible_injuries)
...
func roll_elbow_attack_injury(): #for the player who attacks another with their elbow
	var possible_injuries = {
		"bruised_elbow_minor": 10.0,
		"bruised_elbow_major": 10.0,
		"dislocated_elbow": 1.0,
		"broken_elbow": 2.0,
		"torn_elbow_ligament": 0.01,
		"dislocated_shoulder": 1.0,
...
func roll_gauntlet_attack_injury(): #from punching or kicking opponent
	var possible_injuries = {
		"bruised_finger_minor_dominant": 10.0,
		"bruised_finger_major_dominant": 3.0,
		"broken_finger_dominant": 1.0,
		"bruised_wrist_minor_dominant": 10.0,
		"bruised_wrist_major_dominant": 3.0,
		"broken_wrist_dominant": 1.0,
		"toenail_off": 1.0,
		"toe_bruise_minor": 10.0,
		"toe_bruise_major": 3.0,
		"broken_toe": 1.0,
		"foot_bruise_minor": 10.0,
		"foot_bruise_major": 3.0,
		"broken_foot": 1.0,
	}
	return get_weighted_choice(possible_injuries)

func roll_gauntlet_injury(): #from being punched or kicked
	var crotch = roll_crotch_injury()
	var head = roll_fight_injury()
	var trip = roll_trip_injury()
	var back = roll_targeted_back_injury()
	var brain = roll_targeted_head_injury()
	var array = [crotch, head, trip, back, brain]
	return array.pick_random()

func roll_crotch_injury(): #from being hit in the crotch
	var possible_injuries = {
		"bruised_crotch_minor": 10.0,
		"bruised_crotch_major": 2.0,
		"destroyed_crotch": 0.05,
		"pulled_groin_minor": 2.0,
		"pulled_groin_major": 0.5,
	}
	return get_weighted_choice(possible_injuries)
...
func roll_grab_attack_injury(): #from grabbing, holding, or throwing opponent
	var possible_injuries = {
		"bruised_finger_minor_dominant": 10.0,
		"bruised_finger_major_dominant": 2.0,
		"bruised_finger_minor_weak": 10.0,
		"bruised_finger_major_weak": 2.0,
		"sprain_thumb_dominant": 1.0,
		'sprain_thumb_weak': 1.0,
		"bruised_wrist_minor_dominant": 2.0,
		"bruised_wrist_major_dominant": 0.5,
		"bruised_wrist_minor_weak": 2.0,
		"bruised_wrist_major_weak": 0.5,
		"bruised_arm_minor": 0.3,
		"bruised_arm_major": 0.1,
		"bicep_pull_minor": 1.0,
		"bicep_pull_major": 0.06,
		"ham_pull_minor": 0.7,
		"ham_pull_major": 0.02,
		"dislocated_elbow": 1.0,
		"disloacted_shoulder": 0.05,
		"dislocated_hip": 0.01,
	}
	return get_weighted_choice(possible_injuries)
...
func roll_bite_injury(): #from being bitten
	var possible_injuries = {
		...
		"leg_cut_minor": 3.0,
		"leg_cut_major": 0.9,
		"scrappers_disease": 1.0,
		"broken_finger_dominant": 2.4,
		"broken_finger_weak": 1.6,
	}
	return get_weighted_choice(possible_injuries)
...
func roll_gouge_attack_injury(): #from doing the eye gouging
	var possible_injuries = {
		"bruised_finger_minor_dominant": 10.0,
		"bruised_finger_major_dominant": 4.0,
		"broken_finger_dominant": 1.6,
		"sprain_thumb_dominant": 1.0,
		"bruised_finger_minor_weak": 4.0,
		"bruised_finger_major_weak": 1.6,
		"broken_finger_weak": 0.64,
		"sprain_thumb_weak": 1.0,
	}
	return get_weighted_choice(possible_injuries)

func roll_grab_injury(): #from being grabbed and held
	var possible_injuries = {
		# Bruising
		"bruised_arm_minor": 5.0,
		"bruised_arm_major": 1.0,
		"bruised_shoulder_minor": 5.0,
		"bruised_shoulder_major": 1.0,
		"bruised_wrist_minor_dominant": 5.0,
		"bruised_wrist_major_dominant": 1.0,
		"bruised_wrist_minor_weak": 5.0,
		"bruised_wrist_major_weak": 1.0,
		"bruised_finger_minor_dominant": 1.0,
		"bruised_finger_major_dominant": 0.2,
		"bruised_finger_minor_weak": 1.0,
		"bruised_finger_major_weak": 0.2,
		"bruised_knee_minor": 1.0,
		"bruised_knee_major": 0.2,
		"bruised_thigh_minor": 1.0,
		"bruised_thigh_major": 0.2,
		# Dislocations
		"disclocated_shoulder": 0.2,
		"dislocated_elbow": 0.2,
		"dislocated_knee": 0.02,
		"dislocated_hip": 0.02,
		# Ligaments and muscles
		"sprained_ACL_minor": 0.4,
		"sprained_ACL_major": 0.04,
		"torn_ACL": 0.004,
		"sprained_LCL_minor": 0.3,
		"sprained_LCL_major": 0.03,
		"torn_LCL": 0.003,
		"torn_rotator_cuff": 1.0,
		"torn_elbow_ligament": 0.5,
		"torn_labrum": 0.1,
		...
		"calf_pull_major": 0.2,
		"bicep_pull_minor": 1.0,
		"bicep_pull_major": 0.2,
		"tricep_pull_minor": 1.0,
		"tricep_pull_major": 0.2,
		"peck_pull_minor": 1.0,
		"peck_pull_major": 0.2,
		"pulled_groin_minor": 1.0,
		"pulled_groin_major": 0.2,
	}
	return get_weighted_choice(possible_injuries)
